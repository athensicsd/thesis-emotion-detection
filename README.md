...
Για να γίνει η ανάγνωση των δεδομένων χρησιμοποιήθηκε η εντολή load_xdf στο MATLAB. Γενικά όλα τα script που φορτώθηκαν στο MATLAB είναι ανεβασμένα και έχουν κατάληξη .m
...
Όλα τα δεδομένα που αφορούν τα σήματα ECG και EDA βρίσκονται στο : https://drive.google.com/drive/folders/1UA2hp7aGDTdxPdnMZ9TfwmozNgscCDGq
